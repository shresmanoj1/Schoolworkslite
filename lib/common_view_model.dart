...
class CommonViewModel extends ChangeNotifier {
  ...
  Future<void> fetchStudentformarking(batchss) async {
    ...
    try {
      ...
      if (res.success == true) {
        ...
        print("STUDENT ROLL NUMBER:::${_studentMarking}");
  ...
  Future<void> getAuthenticatedUser() async {
    ...
    notifyListeners();
    try {
      print("INSIDE common VIEW MODEL:::::");
      Authenticateduserresponse res =
  ...
  Future<void> fetchmyJourney() async {
    ...
    try {
      ...
      print("API Response: ${res.toJson()}");
      if (res.success == true) {
        _journal = res.journal!;
        print("Fetched Journals: $_journal");
  ...
  Future<void> fetchEvents() async {
    ...
    try {
      ...
      print("EVENT RESPONSE:::${res.events}");
      if (res.success == true) {
        ...
        //   if (res.events[i].startDate.year == _currentDate.year &&
        //       res.events[i].startDate.month == _currentDate.month &&
        //       res.events[i].startDate.day == _currentDate.day) {
        //     _events.add(res.events[i]);
        //     print("AL EVENTS:::${_events}");
        //   }
        // }
  ...
  Future<void> fetchStudentBus() async {
    ...
    try {
      ...
      if (res.success == true) {
        _studentBus = res;
        print("student bus::${_studentBus.toJson()}");
