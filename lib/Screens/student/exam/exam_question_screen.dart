  ...
  submitFinalAnswerApi() async {
    try {
      ExamCompletedResponse res = await ExamRepository()
          .examCompleted(_provider.examWithQuestion.exam!.sId.toString());
      setState(() {
        isloading = false;
      });
      ...
      return Scaffold(
        body: isLoading(viewModel.examWithQuestionApiResponse)
            ...
            : DefaultTabController(
                length: viewModel.examWithQuestion.exam!.questions!.length,
                child: Scaffold(
                  appBar: AppBar(
                    title: Row(
                  ...
                  body: RefreshIndicator(
                    onRefresh: () async {
                      ...
                      await viewModel.fetchExamWithQuestion(
                          viewModel.examDetails.exam!.id.toString());
                    },
                    child: NestedScrollView(
                      ...
                      body: isLoading(viewModel.myAnswerApiResponse)
                          ...
                          : TabBarView(
                              ...
                              children: <Widget>[
                                ...List.generate(
                                    viewModel.examWithQuestion.exam!.questions!
                                        .length, (index) {
                                  return SafeArea(
                                    top: false,
                                    bottom: false,
                          ...
                          try {
                            ...
                            final request = jsonEncode({
                              ...
                              "objectiveAnswers": viewModel
                                  ...
                                  ? finalAnswer
                                  : [],
                              "question": viewModel.examWithQuestion.exam!
                                  .questions![_tabController.previousIndex].sId
                                  .toString()
                            });
