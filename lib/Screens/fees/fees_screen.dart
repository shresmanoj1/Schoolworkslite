...
class _FeesscreenState extends State<Feesscreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      // _provider.getPaymentTransactionInfo(user?.institution.toString() ?? "");
    });
    super.initState();
    transactionStart();
  ...
  transactionStart() async {
    ...
    // final data = Institutionrequest(institution: user?.institution.toString());
    //
    // due_start = FeeService().duedatastart(data);
    // due_start = FeeService().duedatastart(data);
    //
    // due_finish = FeeService().duedatafinish(data);
    //
    // final checkData = await FeeService().duedatafinish(data);
    ...
    //       });
    //       // print("duesList::::" + jsonEncode(duesList.toString()));
    //     } else {
    //       // print('no due');
    //     }
    //   }
