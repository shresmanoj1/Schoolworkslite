            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Align(
                    alignment: Alignment.center,
                    child: Image.asset('assets/images/schoolworkslite_full.png',
                        width: 200),
                  ),
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      children: [
                        const TextSpan(
                          text: "By clicking Signing In, you are agreeing to SchoolWorksPro's ",
                          style: TextStyle(color: Colors.black38, fontSize: 12),
                        ),
                        TextSpan(
                          text: "Privacy Policy",
                          style: const TextStyle(color: Colors.blue,fontWeight: FontWeight.w500, fontSize: 12),
                          recognizer: TapGestureRecognizer()..onTap = () =>_launchURL("https://schoolworkspro.com/policies")
                        ),
                      ],
                    ),
