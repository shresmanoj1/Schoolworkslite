...
import 'package:schoolworkspro_app/services/journal_service.dart';

import '../../../api/repositories/Journal_repository.dart';
// import '../../../api/repositories/addJournal_repository.dart';
...
//                               List<GetJournal> filteredList =
//                                   _listJournal.where((journal) {
//                                 var itemName = journal.title!.toLowerCase();
//                                 return itemName.contains(text);
//                               }).toList();
//
//                               print(
//                                   'Filtered Journals: ${filteredList.map((journal) => journal.title).toList()}');
//
//                               setState(() {
...
//                                 GetJournal journaldatas =
//                                     _JournalListDisplay[index];
//                                 DateTime date = DateTime.parse(
//                                     journaldatas.createdAt!.toString());
