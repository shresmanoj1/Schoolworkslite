  ...
  getUser() async {
    ...
    if (widget.element != null) {
      try {
        ...
        selectedLecturer = widget.teacher == null || widget.teacher == ""
            ? widget.element["lecturer"]["email"]
            : widget.teacher;
        selectedReplaceLecturer = widget.teacher == null || widget.teacher == ""
            ? widget.element["lecturer"]["email"]
            : widget.teacher;
        classRoomController =
          ...
          try {
            for (var i = 0; i < _provider3.allbatches.length; i++) {
              if (widget.batch != null) {
                if (widget.batch == _provider3.allbatches[i].batch) {
            ...
            Map<String, dynamic> request = {
              "batch": widget.batch ?? widget.element["batch"],
            ...
            _provider2.fetchAccessedModules(request).then((_) {
              try {
                for (var i = 0;
                    ...
                    i++) {
                  if (_provider2.accessModules.modules![i].moduleSlug ==
