...
class _MynoticeprincipalbodyState extends State<Mynoticeprincipalbody> {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer2<AnnouncementViewModel, CommonViewModel>(
      ...
      return Scaffold(
        ...
        body: isLoading(data.mynoticeApiResponse)
            ? Center(
                child: SpinKitDualRing(
                  color: kPrimaryColor,
                ),
              )
            : data.mynotice.isEmpty
                ? Column(
                ...
                : ListView(
                    children: [
                      ...List.generate(
                          data.mynotice.length,
                          (index) => Builder(builder: (context) {
                                var notice = data.mynotice[index];
            ...
            onTap: () {
              ...
              Navigator.push(
                  ...
                  PageTransition(
                      ...
                      type: PageTransitionType.leftToRight)).then((value) => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => super.widget,)));
            },
          ),
