...
import 'package:schoolworkspro_app/Screens/lecturer/my-modules/components/more_component/soft_marks/soft_mark_student_screen.dart';
import 'package:schoolworkspro_app/Screens/lecturer/my-modules/components/more_component/soft_marks/soft_view_grade_screen.dart';
...
class SoftAddGradeScreen extends StatefulWidget {
  List<dynamic> modules;
  SoftAddGradeScreen({Key? key, required this.modules}) : super(key: key);

  @override
  _SoftAddGradeScreenState createState() => _SoftAddGradeScreenState();
}

class _SoftAddGradeScreenState extends State<SoftAddGradeScreen> {
                            ...
                            children: [
                              OutlinedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    // }
                                    // else
                                    //   if (selected_headingType == null) {
                                    //   Fluttertoast.showToast(
                                    //       msg: "select Weightage type");
                                    // } else
                                    if (grade.heading.marksTitle == null ||
                                        grade.heading.marksTitle!.isEmpty) {
                                      Fluttertoast.showToast(
                                          msg: "Weightage not found");
                                    } else {
                                      // print(
                                      //     "VALUEEE::::::: $selected_headingType");
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) =>
                                                SoftMarkStudentGrade(
                                                    moduleSlug: selected_module,
