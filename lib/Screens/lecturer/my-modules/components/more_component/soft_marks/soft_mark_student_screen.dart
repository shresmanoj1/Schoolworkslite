...
class SoftMarkStudentGrade extends StatefulWidget {
  final moduleSlug;
  final data;
  final examId;

  const SoftMarkStudentGrade(
      {Key? key, this.moduleSlug, this.data, this.examId})
      : super(key: key);

  @override
  _SoftMarkStudentGradeState createState() => _SoftMarkStudentGradeState();
}

class _SoftMarkStudentGradeState extends State<SoftMarkStudentGrade> {
              ...
              onChanged: (newVal) {
                setState(() {
                  ...
                  _provider2.fetchViewStudentGrade(widget.moduleSlug,
                      selected_batch.toString(), widget.examId, "Soft");
                  _provider2
                      .fetchMarksHeadings(widget.moduleSlug,
                          selected_batch.toString(), widget.examId, "Soft")
                      .then((value) {
                      ...
                      if (common.studentMarking.length > 0 &&
                        ...
                        lecturer.fetchModuleDetails(data22).then((_) {
                          ...
                          if (lecturer.modules["isOptional"]) {
                            for (var i = 0;
                                i < common.studentMarking.length;
                                i++) {
                              if (lecturer.modules["optionalStudent"].contains(
                                  common.studentMarking[i]['username'])) {
                                studentIndex = i - 1;
                                listForDisplay.add({
                                ...
                                __controllers.add([]);
                                courseSlug =
                                    common.studentMarking.first['courseSlug'];
                                for (var j = 0;
                                    j <
                                        (grade.marksHeading.marksTitle == null
                                            ? 0
                                            : grade.marksHeading.marksTitle!
                                                .length);
                                    j++) {
                                  var lastIndex = __controllers.length - 1;
                                  __controllers[lastIndex]
                              ...
                              for (var j = 0;
                                  j <
                                      (grade.marksHeading.marksTitle == null
                                          ? 0
                                          : grade
                                              .marksHeading.marksTitle!.length);
                                  j++) {
                                          ...
                                          onPressed: () async {
                                            ...
                                            try {
                                              ...
                                              for (var i = 0;
                                                  ...
                                                  i++) {
                                                Mark _mark = Mark(
                                                  name: listForDisplay[i]
                                                          ["firstname"] +
                                                      " " +
                                                      listForDisplay[i]
                                                          ["lastname"],
                                                  username: listForDisplay[i]
                                                      ["username"],
                                                  data: [],

                                                  // isAbsent: listForDisplay[i]
                                                  //     ["isAbsent"]
                                                );
                                                for (var j = 0;
                                                    j <
                                              ...
                                              print(
                                                  "OVERALLL MARKS IS :::${marks.toString()}");
                                              // final request =
