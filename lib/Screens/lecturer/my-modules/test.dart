...
//   final moduleslug;
//   const LearningDetailLecturer({Key? key, this.moduleslug}) : super(key: key);
//
//   @override
//   _LearningDetailLecturerState createState() => _LearningDetailLecturerState();
// }
//
...
//                                                                           //     : null,
//                                                                           title: Text(
//                                                                             "Lecture $index : " + datas.lessons![i].lessonTitle.toString(),
...
//                                                                               onPressed: () async {
//                                                                                 try {
//                                                                                   final res = await AddLessonService().deleteLesson(datas.lessons![i].lessonSlug.toString());
//                                                                                   if (res.success == true) {
//                                                                                     snackThis(context: context, duration: 2, color: Colors.green, content: Text(res.message.toString()));
//                                                                                   } else {
//                                                                                     snackThis(context: context, duration: 2, color: Colors.red, content: Text(res.message.toString()));
//                                                                                   }
//                                                                                 } on Exception catch (e) {
//                                                                                   snackThis(context: context, duration: 2, color: Colors.red, content: Text(e.toString()));
//                                                                                   // TODO
//                                                                                 }
//                                                                               },
//                                                                               icon: const Icon(
