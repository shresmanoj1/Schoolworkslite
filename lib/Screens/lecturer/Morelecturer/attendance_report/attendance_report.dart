...
class _AttendanceReportLecturerState extends State<AttendanceReportLecturer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //       Expanded(
        //         flex: 8,
        //         child: FutureBuilder<AttendanceReportResponse>(
        ...
        //                 itemBuilder: (context, index) {
        //                   var datas = snapshot.data?.allAttendance?[index];
        //                   return Column(
        //                     mainAxisAlignment: MainAxisAlignment.start,
        //                     crossAxisAlignment: CrossAxisAlignment.start,
        //                     children: [
        //                       GFListTile(
        //                         title: Text(
        //                             "Student ID: " + datas!.username.toString()),
        //                         subTitle: Column(
        //                           mainAxisAlignment: MainAxisAlignment.start,
        //                           crossAxisAlignment: CrossAxisAlignment.start,
        //                           children: [
        //                             Text(
        //                                 "Student Name: " + datas.name.toString()),
        //                             datas.contact == null
        //                                 ? SizedBox()
        //                                 : Text("Contact: " +
        //                                 datas.contact.toString()),
        //                           ],
        //                         ),
        //                         icon: CircularPercentIndicator(
        //                           radius: 45.0,
        //                           lineWidth: 6.0,
        //                           percent: (datas.percentage!.toDouble() / 100),
        //                           center: Text(
        //                             datas.percentage!.toString().split('.')[0] +
        //                                 "%",
        ...
        //                           children: [
        //                             Text("Total Sessions: " +
        //                                 datas.totalDays.toString()),
        //                             Text("Present Days: " +
        //                                 datas.presentDays.toString()),
        //                             Text("Absent Days: " +
        //                                 datas.absentDays.toString()),
