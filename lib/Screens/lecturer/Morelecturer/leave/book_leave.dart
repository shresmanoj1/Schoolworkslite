...
class MyCustomAlertDialog extends StatefulWidget {
  ...
  const MyCustomAlertDialog({Key? key, required this.leave, required this.username}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              height: isHalfDayCheck == false ? 370 : 440,
              width: double.infinity,
              child: isLoading(widget.leave.leaveTypeResponse)
                  ? const Center(
                      child: CupertinoActivityIndicator(),
                    )
                  : isError(widget.leave.leaveTypeResponse)
                      ? const Center(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField(
                                ...
                                items: widget.leave.leave.map((pt) {
                                                      ...
                                                      try {
                                                        if (_mySelection ==
                                                          ...
                                                          if (res.success ==
                                                            ...
                                                            // Navigator.pop(context);
                                                            // LeaveService().getleave(widget.username ?? "");

                                                            // widget.leave.fetchBookLeave();
