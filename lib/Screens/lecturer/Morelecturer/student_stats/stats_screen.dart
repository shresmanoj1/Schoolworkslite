...
import 'package:schoolworkspro_app/Screens/lecturer/Morelecturer/student_stats/components/absent_details_stats.dart';
...
class _StatsDetailScreenState extends State<StatsDetailScreen> {
  ...
  void initState() {
    ...
    print("REQUESTED DATA::::${widget.data}");
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      model.hasPermission(["set_student_disciplinary_act"]) ==
                              false
                          ? logisticsWidget()
                          : Expanded(
                              child: InkWell(
