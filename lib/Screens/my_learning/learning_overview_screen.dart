...
import 'package:schoolworkspro_app/Screens/student/exam/exam_layout.dart';
...
import 'package:schoolworkspro_app/response/syllabus_batch_module_status_response.dart';
            ...
            content: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ...List.generate(
                  //   syllabus == null ? 0 : syllabus.length,
                  //   (index) =>
                  //       Container(
                  //         height: 100,
                  //         child: ListView.builder(
                  //         shrinkWrap: true,
                  //         itemCount: syllabus![0]["docs"]!.length,
                  //         itemBuilder: (context, innerIndex) {
                  //           final datas = syllabus[0]["docs"]![innerIndex];
                  //           return richTextWidget(
                  //               "Lecturer.", datas["lecturer"].toString());
                  //         }),
                  //       ),
                  // ),
                  const SizedBox(
