    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
                          ...
                          children: [
                            Expanded(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  // Navigator.push(context, MaterialPageRoute(builder: (context) => RoutineLecturer(),));
          ...
          //         //     mainAxisSpacing: 3.0,
          //         //     children: List.generate(snapshot.data!.allProgress!.length, (index) {
          //         //       var progress = snapshot.data!.allProgress![index];
          ...
          //         //         width: 140.0,
          //         //         lineHeight: 14.0,
          //         //         center: Text(progress['progress'].toString()+"%",style: TextStyle(fontSize: 12),),
          //         //         percent:progress['progress']/100 ,
          //         //         // header:Center(child: Text(progress['moduleTitle'],overflow: TextOverflow.ellipsis,)),
          //         //         backgroundColor: Colors.grey,
          //         //         progressColor: progress['progress'] == 100 ? Colors.green : Colors.blue,
          //         //       );
          //         //     }
          //         //     ));
