...
class AssignedToRequest extends StatefulWidget {
  const AssignedToRequest({Key? key}) : super(key: key);

  @override
  State<AssignedToRequest> createState() => _AssignedToRequestState();
}

class _AssignedToRequestState extends State<AssignedToRequest> {
              ...
              return snapshot.data!.requests!.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        // if(widget.requestName.toString() == 'Pending'){
                        //   return ticket['status'] == widget.requestName.toString() || ticket['status'] == 'Backlog' ?
                        //
                        //   myRequest(ticket, formattedTime) : Container();
                        // }
